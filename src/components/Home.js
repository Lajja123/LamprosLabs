    ...
    <>
      <div className="lmplab-homepage-main-bg">
        ...
        <ScrollBtn
          ...
          section3={section3}
        />
        <section className="homepage-secion1-main" ref={section1}>
          ...
          <div className="section2-flex">
            <div>
              <p className="section2-pera">
                At Lampros Labs, we are pushing the boundaries of what's
                possible with web3 technology. Our innovative solutions empower
                individuals and or ganizations to take control of their digital
                assets and data, fostering a decentralized future where
                transparency and security are the norm. We are dedicated to
                making decentralized systems accessible and easy for everyone,
                join us in leading the way towards a more equitable and
                transparent society through web3 technology.
              </p>
            </div>
            <Link to="/about-Us">
        ...
        <section className="homepage-secion3-main-tablet" ref={section2}>
        ...
        <section className="homepage-secion3-main" ref={section2}>
        ...
        <section className="homepage-secion4-main " ref={section3}>
